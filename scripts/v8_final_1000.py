# -*- coding: utf-8 -*-
"""V8 Comprehensive Local Stress Test - 1000x Samples"""
...
print("--- V8 Validation Start (1000 samples/type) ---")
results = []
for t in types_to_test:
    ...
    for i in range(1000):
        ...
        if (i+1) % 200 == 0:
            print(f"[{t}] Progress: {(i+1)}/1000 ({round((i+1)/1000*100, 1)}%)")
    rate = round(passed/1000*100, 2)
    results.append(f"[{t}] Pass Rate: {passed}/1000 ({rate}%)")
    print(results[-1])
